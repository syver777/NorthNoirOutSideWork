    ...
    try:
        ...
        if final_assembly_flag:
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                if estimated_size > 4.5:
                    print(
                        f"Estimated final video size ({estimated_size:.2f} GB) exceeds 4.5 GB limit, delegating to high-memory function")
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            if video_loop_url:
                ...
                if len(individual_videos_paths) == 1 and individual_videos_paths[0] == video_loop_url:
                    ...
                    if estimated_size > 6.5:
                        print(
                            f"Estimated looped video size ({estimated_size:.2f} GB) exceeds 6.5 GB limit, delegating to high-memory function")
                        return add_cors_headers(request, delegate_to_high_memory(data))
                    ...
                    if len(individual_videos_paths) == 1 and "video_loop" in individual_videos_paths[0]:
                        ...
                        if estimated_size > 6.5:
                            print(
                                f"Estimated video loop size ({estimated_size:.2f} GB) exceeds 6.5 GB limit, delegating to high-memory function")
                            return add_cors_headers(request, delegate_to_high_memory(data))
                ...
                if estimated_size > 6.0:
                    print(
                        f"Estimated final video size ({estimated_size:.2f} GB) exceeds 6 GB limit, delegating to high-memory function")
                    return add_cors_headers(request, delegate_to_high_memory(data))
